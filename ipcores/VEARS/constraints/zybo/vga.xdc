...
set_property PACKAGE_PIN F20 [get_ports {vga_green[4]}]
set_property PACKAGE_PIN H20 [get_ports {vga_green[3]}]
set_property PACKAGE_PIN J19 [get_ports {vga_green[2]}]
set_property PACKAGE_PIN L19 [get_ports {vga_green[1]}]
set_property PACKAGE_PIN N20 [get_ports {vga_green[0]}]

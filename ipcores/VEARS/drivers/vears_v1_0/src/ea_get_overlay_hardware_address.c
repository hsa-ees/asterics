...
----------------------------------------------------------------------------------
-- File:           ea_get_overlay_hardware_address.c
--
...
--
-- Description:    Return the current hardware processed overlay address.
--------------------------------------------------------------------------------*/
...
{
  return hardware_overlay_address; //return the address used by the overlay-hardware
}

...
----------------------------------------------------------------------------------
-- File:           ea_set_overlay_hardware_address.c
--
...
--
-- Description:    Sets the hardware processing overlay address.
--------------------------------------------------------------------------------*/
...
ea_bool ea_set_overlay_hardware_address(uint32_t *address)
{
  hardware_overlay_address = address; //writes the address for the overlayhardware to the global hardware_overlay_address

  vears_overlay_show (VEARS_BASEADDR, (vears_overlay_t *) address);

...
# -----------------------------------------------------------------------------
"""
as_2d_conv_filter_internal_spec.py
...
of the ASTERICS hardware module as_2d_conv_filter_internal.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_2d_conv_filter_internal_spec.py
# @author Philip Manke
# @brief Specifics for as_2d_conv_filter_internal used by as_automatics
# -----------------------------------------------------------------------------

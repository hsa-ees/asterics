...
def get_module_instance(module_dir: str) -> AsWindowModule:
    ...
    toplevel_file = "hardware/vhdl/as_cordic_direction.vhd"
    module.files = [
        "hardware/vhdl/as_cordic_atan_pipe.vhd",
        "hardware/vhdl/as_cordic_pkg.vhd",
    ]
    module.dependencies = ["as_filter_mask"]
    ...
    # Negative delays have not been tested!
    module.processing_delay = 10

...
of the ASTERICS hardware module as_feature_counter.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_feature_counter_spec.py
# @author Philip Manke
# @brief Specifics for as_feature_counter used by as_automatics
# -----------------------------------------------------------------------------

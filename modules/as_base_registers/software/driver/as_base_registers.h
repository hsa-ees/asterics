...
-- Modified:       
--
-- Description:    Driver (header file) for as_base_registers module.
----------------------------------------------------------------------------------
...
#ifndef AS_BASE_REGISTERS_H
#define AS_BASE_REGISTERS_H

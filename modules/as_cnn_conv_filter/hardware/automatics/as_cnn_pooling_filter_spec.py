...
of the ASTERICS hardware module as_cnn_pooling_filter.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_cnn_pooling_filter_spec.py
# @author Philip Manke
# @brief Specifics for as_cnn_pooling_filter used by as_automatics
# -----------------------------------------------------------------------------

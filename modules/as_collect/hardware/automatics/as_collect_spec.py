...
of the ASTERICS hardware module as_collect.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_collect_spec.py
# @author Philip Manke
# @brief Specifics for as_collect used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module = AsModule("as_collect")
    toplevel_file = "hdl/vhdl/as_collect.vhd"
    module.files = []
    module.dependencies = []

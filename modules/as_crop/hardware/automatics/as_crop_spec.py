...
of the ASTERICS hardware module as_crop.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_crop_spec.py
# @author Philip Manke
# @brief Specifics for as_crop used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module = AsModule("as_crop")
    toplevel_file = "hdl/vhdl/as_crop.vhd"
    module.files = []
    module.dependencies = []

...
of the ASTERICS hardware module as_invert.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_invert_spec.py
# @author Philip Manke
# @brief Specifics for as_invert used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir):
    ...
    module = AsModule("as_invert")
    toplevel_file = "hardware/hdl/vhdl/as_invert.vhd"

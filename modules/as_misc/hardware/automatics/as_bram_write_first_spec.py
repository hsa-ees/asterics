...
of the ASTERICS hardware module bram write first hardware description.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_bram_write_first_spec.py
# @author Philip Manke
# @brief Specifics for the simple bram module used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    toplevel_file = "hardware/hdl/vhdl/ram/BRAM_WRITE_FIRST.vhd"

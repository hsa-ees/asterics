...
of the ASTERICS hardware support library 'cnn_helpers'.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_cnn_helpers_spec.py
# @author Philip Manke
# @brief Specifics for support library 'cnn_helpers' used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module.files = ["hardware/hdl/vhdl/pkg/as_cnn_helpers_pkg.vhd"]
    ...
    module.name = "as_cnn_helpers"
    module.entity_name = "as_cnn_helpers"
    module.generics = []

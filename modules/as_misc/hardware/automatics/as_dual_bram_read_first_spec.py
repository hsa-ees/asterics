...
# -----------------------------------------------------------------------------
"""
as_dual_bram_read_first_spec.py
...
of the ASTERICS hardware module dual bram read first hardware description.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_dual_bram_read_first_spec.py
# @author Philip Manke
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    toplevel_file = "hardware/hdl/vhdl/ram/DUAL_BRAM_READ_FIRST.vhd"

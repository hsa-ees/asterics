...
# -----------------------------------------------------------------------------
"""
as_dual_bram_read_write_spec.py
...
of the ASTERICS hardware module dual bram read write hardware description.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_dual_bram_read_write_spec.py
# @author Philip Manke
# @brief Specifics for the simple dual bram module used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    toplevel_file = "hardware/hdl/vhdl/ram/DUAL_BRAM_READ_WRITE.vhd"

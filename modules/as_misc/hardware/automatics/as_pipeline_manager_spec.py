...
of the ASTERICS hardware support library 'as_pipeline_manager'.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_pipeline_manager_spec.py
# @author Philip Manke
# @brief Specifics for support component 'as_pipeline_manager' used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsWindowModule:
    ...
    toplevel_file = "hardware/hdl/vhdl/pipeline/as_pipeline_manager.vhd"
    module.files = []

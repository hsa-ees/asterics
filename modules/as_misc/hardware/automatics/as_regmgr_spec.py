...
class SWRegInterface(Interface):
    def __init__(self):
        ...
        sw_data_in.overwrite_rule(
            "sink_missing", "set_value(axi_slv_reg_write_data)"
        )
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module.files = [
        ("hardware/hdl/vhdl/register_interface/" "as_generic_regslice.vhd")
    ]

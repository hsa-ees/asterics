...
of the ASTERICS hardware support library 'as_window_buff_nxm'.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_window_buff_nxm.py
# @author Philip Manke
# @brief Specifics for support component 'as_window_buff_nxm' used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module.files = ["hardware/hdl/vhdl/pipeline/as_window_buff_nxm.vhd"]
    module.dependencies = ["as_pipeline_row"]
    ...
    module.name = "as_window_buff_nxm"
    module.entity_name = "as_window_buff_nxm"
    module.generics = []

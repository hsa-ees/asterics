...
of the ASTERICS hardware module as_memreader.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_memreader_spec.py
# @author Philip Manke
# @brief Specifics for as_memreader used by as_automatics
# -----------------------------------------------------------------------------
...
class SimReaderRegisterInterface(Interface):

    INTERFACE_TYPE_NAME = "sim_reader_register_interface"

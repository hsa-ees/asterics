...
of the ASTERICS hardware module as_sensor_ov7670_xpm.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_sensor_ov7670_xpm_spec.py
# @author Philip Manke
# @brief Specifics for as_sensor_ov7670_xpm used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module = AsModule()
    toplevel_file = "hardware/hdl/vhdl/as_sensor_ov7670_xpm.vhd"

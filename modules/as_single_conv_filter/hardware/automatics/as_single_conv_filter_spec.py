...
of the ASTERICS hardware module as_single_conv_filter.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_single_conv_filter_spec.py
# @author Philip Manke
# @brief Specifics for as_single_conv_filter used by as_automatics
# -----------------------------------------------------------------------------

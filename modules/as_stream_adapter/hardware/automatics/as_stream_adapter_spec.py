...
# -----------------------------------------------------------------------------
"""
as_stream_adapter_down_spec.py
...
of the ASTERICS hardware module as_stream_adapter_down.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_stream_adapter_down_spec.py
# @author Philip Manke
# @brief Specifics for as_stream_adapter_down used by as_automatics
# -----------------------------------------------------------------------------

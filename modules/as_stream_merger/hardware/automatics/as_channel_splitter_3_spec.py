...
of the ASTERICS hardware module as_channel_splitter_3.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_channel_splitter_3_spec.py
# @author Philip Manke
# @brief Specifics for as_channel_splitter_3 used by as_automatics
# -----------------------------------------------------------------------------

...
of the ASTERICS hardware module as_stream_merger_2.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_stream_merger_2_spec.py
# @author Philip Manke
# @brief Specifics for as_stream_merger_2 used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module = AsModule()
    toplevel_file = "hardware/hdl/vhdl/as_stream_merger_2.vhd"
    module.files = []
    module.dependencies = []

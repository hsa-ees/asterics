...
of the ASTERICS hardware module as_stream_merger_7.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_stream_merger_7_spec.py
# @author Philip Manke
# @brief Specifics for as_stream_merger_7 used by as_automatics
# -----------------------------------------------------------------------------
...
def get_module_instance(module_dir: str) -> AsModule:
    ...
    module = AsModule()
    toplevel_file = "hardware/hdl/vhdl/as_stream_merger_7.vhd"
    module.files = []
    module.dependencies = []

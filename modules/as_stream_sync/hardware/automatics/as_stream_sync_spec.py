...
of the ASTERICS hardware module as_stream_sync.
"""
# --------------------- LICENSE -----------------------------------------------
...
# --------------------- DOXYGEN -----------------------------------------------
##
# @file as_stream_sync_spec.py
# @author Philip Manke
# @brief Specifics for as_stream_sync used by as_automatics
# -----------------------------------------------------------------------------

from as_automatics_module import AsModule
def get_module_instance(module_dir: str) -> AsModule:
    module = AsModule("as_stream_sync")

    toplevel_file = "hardware/hdl/vhdl/as_stream_sync.vhd"

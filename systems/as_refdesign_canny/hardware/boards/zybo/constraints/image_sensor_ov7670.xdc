...
create_clock -period 42.000 -name clk_ov7670_0_pixclk [get_ports ov7670_0_pixclk]
...
set_clock_groups -asynchronous -group FCLK_CLK0 -group [get_clocks clk_ov7670_0_pixclk]

# Data
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_0_data[0]}]

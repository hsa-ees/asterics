...
#-- Author:         Alexander Zoellner, Patrick Zacharias
#--
...
mknod /dev/as_memreader_0_128 c $major 2
mknod /dev/as_memwriter_0_128 c $major 3
mknod /dev/as_mmap_0_in_data c $major 4
mknod /dev/as_mmap_0_out_data c $major 5
mknod /dev/as_mmap_1_in_data c $major 6
mknod /dev/as_mmap_1_out_data c $major 7

# Create the actual devices (expects executable of create-devices)
./create-devices -c

# echo 1 > /sys/kernel/debug/tracing/events/asterics/enable
